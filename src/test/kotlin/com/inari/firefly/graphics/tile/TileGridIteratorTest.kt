...
class TileGridIteratorTest {

    @Test
    fun testMapWorldClipToTileMapClip() {
...
//        grid1.setHeight( 10 );
//
//        val iterator = grid1!!.tileGridIterator
//
//        val worldClip1 = Rectangle(0, 0, 100, 100)
...
//
//        val worldClip5 = Rectangle(-50, -50, 100, 100)
