...
class Sound private constructor() : TriggeredSystemComponent(Sound::class.simpleName!!) {
    ...
    val controller = ComponentRefResolver(SystemComponentController) { index -> controllerId = index }
